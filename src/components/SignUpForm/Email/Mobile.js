...
export default (props) => <React.Fragment>
	...
	<PrivacyPolicy style={{width: '100%', marginTop: 15}} txtStyle={{fontSize: normalize(12)}} numberOfLines={3} isChecked={props.privacy} onClick={props.togglePrivacyCheckBox}>{POLICY}</PrivacyPolicy>
</React.Fragment>